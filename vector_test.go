...
func Test_ForeEach(t *testing.T) {
	var count int
	var sum int
	V([]int{1, 2}).
...
func Test_MultiplyScalar(t *testing.T) {
	V([]int{1, 0, 3}).
		MultiplyScalar(2).
		ForEach(func(i int, s int) bool {
			switch i {
...
func Test_IsOrthogonal(t *testing.T) {
